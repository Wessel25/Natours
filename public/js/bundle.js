...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var loginBtn = form ? document.querySelector('.btn--green') : null;
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 8:
          ...
          console.error('AxiosError for url: http://127.0.0.1:3000/api/v1/users/login ', _context.t0); // Log the entire error object for debugging

          if (_context.t0.res && _context.t0.res.data && _context.t0.res.data.message) {
            (0, _alerts.showAlert)('error', _context.t0.res.data.message);
          } else {
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
var stripe = Stripe('pk_test_51QVWrjEuGthBljkDtAafPoseXnbdqDbE1DNXIZReSU80vAZLts4BjAUKahiYRNsYWfpKSuOSVKgW0A4wHzHmQ5S200HQ3wU31S');
...
if (loginForm) {
  loginForm.addEventListener('submit', function (e) {
    if (e.target.matches('.form--login')) {
      e.preventDefault();
      console.log('LoginForm Submit: index.js line 10 --at Function: addEventListener()');
